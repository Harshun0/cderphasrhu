...
const ProgramHighlights = () => {
  ...
  const cardData = [
    ...
    {
      id: 2,
      title: 'Tied-up with 250+ Companies',
    ...
    },
    {
      ...
      iconBg: "bg-indigo-500",
      accentColor: "border-indigo-500",
      description: "A Dedicated placement support is provided upon successful completion of the SAP course.It ensures career opportunities in top companies through expert guidance."
    },
    {
      id: 4,
      ...
      iconBg: "bg-indigo-500",
      accentColor: "border-indigo-500",
      description: "The Job Readiness Program prepares learners with industry-required skills.It focuses on making candidates fully confident for employment opportunities"
    }
  ];
